  ...
  uWS::App({
      ...
      .post("/hw_proxy/handshake",
            [](auto *res, auto *) {
              ...
              res->onData([res, bodyBuffer = (std::string *)nullptr](
              ...
              // If you have pending, asynch work, you should abort such work in
              // this callback
              res->onAborted([]() {
                // Again, just printing is not enough, you need to abort any
                // pending work here so that nothing will call res->end, since
                // the request was aborted and deleted
      ...
      .options("/hw_proxy/*",
               [](auto *res, auto *) {
                 ...
                 res->writeHeader("Access-Control-Allow-Headers",
                                  ...
                                  "Accept, Authorization, X-Debug-Mode");
      ...
      .post("/hw_proxy/status_json",
            [](auto *res, auto *) {
              ...
              res->onAborted([]() { printf("Stream was aborted!\n"); });
            })
      ...
      .listen(http_port,
              [](auto *listen_socket) {
                if (listen_socket) {
                  //          std::cout << "Listening on port " << 9069 <<
                  //          std::endl;
